...
class requestHandler(tornado.web.RequestHandler):
   def get(self):
      ...
      print(bboxes['uk'][0])
      print(bboxes['uk'][2]) 
      print(clamp(lon0,bboxes['uk'][0],bboxes['uk'][2]))
      print()
      print(lat0)
      print(bboxes['uk'][1])
      print(bboxes['uk'][3])
      print(clamp(lon0,bboxes['uk'][1],bboxes['uk'][3]))
      print()
      print(lon1)
      print(bboxes['uk'][0])
      print(bboxes['uk'][2])
      print(clamp(lon1,bboxes['uk'][0],bboxes['uk'][2]))
      print()
      print(lat1)
      print(bboxes['uk'][1])
      print(bboxes['uk'][3])
      print(clamp(lon1,bboxes['uk'][1],bboxes['uk'][3]))
      print()
